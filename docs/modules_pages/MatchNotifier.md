...
Ce module envoie des notifications pour les matchs à venir via une tâche planifiée (cron). Il récupère les matchs futurs, vérifie s'ils commencent bientôt et s'ils ont des casters assignés, puis envoie une notification dans le salon approprié en mentionnant le rôle de notification correspondant.
